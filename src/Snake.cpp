...
// Note that I divided the given speed by 2, that's because it makes more sense to have the "default" speed as 1, but if
// you don't actually divide it by 2 (thus actually setting mSpeed as 0.5) it will actually be too fast.
Snake::Snake(const float& x,
             const float& y,
             const float& speed,
             const float sizeOfSquare,
